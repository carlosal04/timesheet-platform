...
namespace TimeSheet.Modules.EmploymentManagement.Application.Addresses.Create;
...
public sealed class Handler
{
    ...
    public async Task<Result> Handle(Command command, CancellationToken cancellationToken)
    {
        ...
        return await _employeeAddressService.CreateAsync(command, cancellationToken);
    }
}
