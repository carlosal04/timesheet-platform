...
public sealed class AddressDeleteEndpointsTests : IClassFixture<AuthApiFactory>
{
    private const string AuthCookieName = "ems.auth";
    private readonly AuthApiFactory _factory;

    public AddressDeleteEndpointsTests(AuthApiFactory factory)
    {
        _factory = factory;
    }

    [Fact]
    public async Task DeleteEmployeeAddress_SoftDeletesAddress()
    {
    ...
    [Fact]
    public async Task DeleteEmployeeAddress_WhenPrimary_PromotesOldestReplacement()
    {
        await _factory.ResetDatabaseAsync();
    ...
    [Fact]
    public async Task DeleteEmployeeAddress_ForAlreadyDeletedAddress_ReturnsConflict()
    {
        await _factory.ResetDatabaseAsync();
    ...
    [Fact]
    public async Task DeleteEmployeeAddress_ForMissingAddress_ReturnsNotFound()
    {
        await _factory.ResetDatabaseAsync();
